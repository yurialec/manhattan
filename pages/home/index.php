...
use App\Core\Controller\Atracoes\AtracoesController;
...
<main class="main mb-0">
	...
	<?php if ($area["atracoes"]) : ?>
		<?php $listarAtracoes = new AtracoesController; ?>

		<?php foreach ($listarAtracoes->listar() as $atracao) : ?>
			<?php extract($atracao); ?>
			<p><?= $id ?></p>
		<?php endforeach; ?>
	<?php endif; ?>
...
?>
	...
	<div class="alertRetorno" id="alertRetorno" onclick="document.getElementById('alertRetorno').style.display='none'">
		<div class="fundoRetorno">
			<a class="fechaalerta text-decoration-none" onclick="document.getElementById('alertRetorno').style.display='none'">X</a>
			<span><svg fill="green" width="44" height="44" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill-rule="evenodd" clip-rule="evenodd">
					<path d="M12 0c6.623 0 12 5.377 12 12s-5.377 12-12 12-12-5.377-12-12 5.377-12 12-12zm0 1c6.071 0 11 4.929 11 11s-4.929 11-11 11-11-4.929-11-11 4.929-11 11-11zm7 7.457l-9.005 9.565-4.995-5.865.761-.649 4.271 5.016 8.24-8.752.728.685z" />
				</svg> <br><br> Sua mensagem foi enviada com sucesso!</span>
		</div>
	</div>
